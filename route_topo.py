...
class VdpSimpleTopo( Topo ):
    ...
    def __init__( self ): 
        ...
        ports = {1:set([1,2,3,4,5,6,7,8]),2:set([1]),3:set([1]),4:set([1]),\
        5:set([1]),6:set([1]),7:set([1]),8:set([1]),9:set([1])}
        links = set([(100001,200001),(100002,300001),(100003,400001),(100004,500001),\
            (100005,600001),(100006,700001),(100007,800001),(100008,900001)])
        switches = ports.keys()
